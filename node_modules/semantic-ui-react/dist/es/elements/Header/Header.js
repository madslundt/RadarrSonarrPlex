...
import { customPropTypes, getElementType, getUnhandledProps, META, SUI, useValueAndKey, useTextAlignProp, useKeyOrValueAndKey, useKeyOnly } from '../../lib';
...
process.env.NODE_ENV !== "production" ? Header.propTypes = {
  ...
  size: PropTypes.oneOf(_without(SUI.SIZES, 'big', 'massive')),
