...
var RCModal = function (_React$Component) {
    ...
    RCModal.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    RCModal.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    ...
    RCModal.prototype.componentDidMount = function componentDidMount() {
        if (this.props.animateAppear && this.props.animationType !== 'none') {
            this.componentDidUpdate({});
        }
    };

    RCModal.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    RCModal.prototype.render = function render() {
        var props = this.props;
